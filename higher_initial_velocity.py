...
class Projectile:
    def __init__(self):
        ...
        self.vel = np.array([900.0, 0.0, 0.0])  # Start 900 m/s (Mach 2.6) -> "Extended Range" muzzle velocity
...
if __name__ == "__main__":
    ...
    plt.title(f'Ramjet Projectile With Higher Launch Velocity (2.6 Mach) (Cd={AeroDatabase().get_cd(2.0):.2f})')
